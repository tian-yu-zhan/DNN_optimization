---
title: "Tutorial for optimizing graphical approach based on FNN"
author: "Tianyu Zhan, Alan H Hartford, Jian Kang, Walter W Offen"
...
In this document, we illustrate how to replicate the case study in the main article. The size of training data B is decreased to 1,000. The R code to replicate simulation studies is provided separately. The user can refer to https://keras.rstudio.com/ for the installation of Keras and Tensorflow. 

## Set up parameters
```{r 1. Setup parameters, echo = T, results = 'hide'}
setwd("~/Dropbox/Research/AbbVie/graph nnw/R_markdown_help_file/")
...
trt.vec = 1.96-qnorm(pow.vec, lower.tail = FALSE) # marginal treatment effect vector based on one-sided type I error 0.025
...
## select the final structure with the largest optimal solution
